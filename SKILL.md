...
description: Use when converting natural-language use-case specs (UC-*.md, e2e-test-spec.md) into ITIL-4/5-aligned Playwright E2E test suites — generating Page Object Models and test specs, mapping test priorities (P0/P1/P2) to ITIL Utility/Warranty dimensions, or producing traceability and quality-gate reports for a testing repo.
---
...
### Step 2: Selector & fixture mapping
...
### Step 4: Generate Playwright test specs
...
### Step 5: Output execution & ITIL quality gate report

Report:

- Created files and directory paths under `/testing-repo/tests/e2e/<feature-folder-name>/`.
- Traceability matrix mapping use case flows to generated test cases.
